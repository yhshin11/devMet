...
process.out = cms.OutputModule(
    ...
    fileName = cms.untracked.string('outStdCHS.root')
)
...
# Turn on jet corrections
# process.load("JetMETCorrections.Configuration.JetCorrectionProducers_cff")
# process.ak4PFL1Fastjet.algorithm = cms.string("AK4PF")
...
process.corrPfMetType1.src = cms.InputTag('ak5PFJetsCHS')
